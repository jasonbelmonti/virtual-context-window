...
import { createVirtualContextEnginePassive } from "./passive-kernel";
import type { CompressionExtractor, PassivePackBudget } from "./passive-contracts";
import { InMemorySymbolStore } from "./symbol-store";
